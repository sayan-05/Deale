    ...
    return (
        <View style={{
            ...
            <Input
                ...
                leftIcon={
                    <Icon2 name="group" size={20} color="rgb(29, 53, 87)" />
                } />
            <Text h4>Select Group Members</Text>
            <ScrollView style={{
                width: '100%'
            }} >
                {
                        ...
                        (i) => {
                            return (
                                <ListItem
                                    ...
                                    key={i._id}
                                    containerStyle={{
                                        backgroundColor: isSelected.includes(i._id) ? "#e6e6e6" : "white",
